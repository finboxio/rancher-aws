resource "aws_security_group" "rancher-staging-analyst-sg" {
  name = "rancher-finboxio-staging-analyst-host-sg"
...
module "analyst" {
  ...
  host_security_group = "${aws_security_group.rancher-staging-analyst-sg.id}"
